...
//go:generate go tool -modfile=../../go.tool.mod gotmpl --body=../shared/semconv/server.go.tmpl "--data={ \"pkg\": \"github.com/tigerwill90/otelfox\" }" --out=server.go
//go:generate go tool -modfile=../../go.tool.mod gotmpl --body=../shared/semconv/server_test.go.tmpl "--data={ \"pkg\": \"github.com/tigerwill90/otelfox\" }" --out=server_test.go
//go:generate go tool -modfile=../../go.tool.mod gotmpl --body=../shared/semconv/client.go.tmpl "--data={ \"pkg\": \"github.com/tigerwill90/otelfox\" }" --out=client.go
//go:generate go tool -modfile=../../go.tool.mod gotmpl --body=../shared/semconv/client_test.go.tmpl "--data={ \"pkg\": \"github.com/tigerwill90/otelfox\" }" --out=client_test.go
